  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden min-h-screen">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-[#5c69c2]/10 to-[#5c69c2]/20" />
          ...
          <div className="w-full">
            <div className="text-center space-y-8">
              <div className="flex items-center justify-center space-x-6 mb-8">
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-[#5c69c2]">
                Eloqura
              </h1>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                <Button 
                  ...
                  className="bg-[#5c69c2] hover:bg-[#5c69c2]/80 text-white px-8 py-3 text-lg"
                >
                  Start Trading
                ...
                <Button 
                  ...
                  className="border-[#5c69c2]/50 hover:bg-[#5c69c2]/10 px-8 py-3 text-lg"
                >
                  Explore Pools
                </Button>
              </div>
            ...
            {stats.map((stat, index) => (
              <Card key={index} className="bg-card/50 border-border/50 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  <stat.icon className="w-8 h-8 mx-auto mb-3 text-[#5c69c2]" />
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardContent className="p-8">
                  <div className={`w-12 h-12 rounded-lg ${feature.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    <feature.icon className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-xl font-semibold mb-3 group-hover:text-[#5c69c2] transition-colors">
                    {feature.title}
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    {feature.description}
                  </p>
                  <div className="flex items-center mt-4 text-[#5c69c2] group-hover:translate-x-2 transition-transform duration-300">
      ...
      <div className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <Card className="bg-gradient-to-r from-purple-900/20 to-[#5c69c2]/20 border-[#5c69c2]/30 backdrop-blur-sm">
            <CardContent className="p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg"
                  onClick={() => navigate('/swap')}
                  className="bg-[#5c69c2] hover:bg-[#5c69c2]/80 text-white px-8 py-3"
                >
                  Get Started Now
                </Button>
                <Button 
                  ...
                  className="border-[#5c69c2]/50 hover:bg-[#5c69c2]/10 px-8 py-3"
                >
                  Learn More
                </Button>
              </div>
