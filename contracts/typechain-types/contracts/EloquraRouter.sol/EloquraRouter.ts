...
export interface EloquraRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface EloquraRouter extends BaseContract {
  connect(runner?: ContractRunner | null): EloquraRouter;
  waitForDeployment(): Promise<this>;

  interface: EloquraRouterInterface;
